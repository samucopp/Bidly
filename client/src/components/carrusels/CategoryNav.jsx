...
const CATEGORY_ICONS = {
    ...
    Music: (
        <svg
            ...
            className="category-icon"
        >
            <path d="M14 3v14" strokeLinecap="round" />
            <path d="M14 17c0 2-1.8 3.5-4 3.5s-4-1.5-4-3.5 1.8-3.5 4-3.5 4 1.5 4 3.5z" />
            <path d="M14 3c-4 0-7 2-7 5" fill="none" strokeLinecap="round" />
            <path d="M14 6c-3 0-5 1.5-5 4" fill="none" strokeLinecap="round" />
        </svg>
    ),
    Clothing: (
        <svg
    ...
    Toys: (
        ...
        >
            ...
            <path d="M7 7 C10 10, 14 14, 17 17" strokeLinecap="round" />
        </svg>
    ),
